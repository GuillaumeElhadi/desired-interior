"""SHA-256 disk cache for composition results.

Cache root: ~/Library/Caches/InteriorVision/compose/<sha256>/result.json
"""
...
def get_cache_root() -> Path:
    ...
    return Path.home() / "Library" / "Caches" / "InteriorVision" / "compose"
